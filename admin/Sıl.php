...
<div class="container">
  ...
  <div class="content">
	...
	<table border='1' bordercolor='blue' bgcolor='#C0C0C0' align='center'>
        <tr align='center'>
        	<td>
				<font color='#FF0000'><b>Ürün Id</b></font>
            </td>
            <td>
            	<font color='#FF0000'><b>Ürün Adı</b></font>
            </td>
			<td>
            	<font color='#FF0000'><b>Ürün Fiyatı</b></font>
            </td>
			<td>
            ...
            <td>
            	<font color='#FF0000'><b>Silme</b></font>
            </td>
        </tr>
<?php
$bg=new mysqli("localhost","root",/*şifre için*/"","alisveris");
	if (isset($_GET['sil']))
	{
		...
		$sorgucuk="delete from urunler where urunid=\"$silinecek_no\" AND urunAdi=\"$silinecek_ad\"";
			$git=mysqli_query($bg,$sorgucuk) or die ("Sorgu çalıştırılamadı.. ".$mysqli->error);
			if ($git) echo "<br> Kayıt başarı ile silinmiştir..";
	}
	else{
...
while($str=mysqli_fetch_array($git))
        ...
        <tr align='center'>
        	<td>
				<font color='#FF0000'><b>$str[0]</b></font>
            </td>
            <td>
            	<font color='#FF0000'><b>$str[1]</b></font>
            </td>
			<td>
            	<font color='#FF0000'><b>$str[2]</b></font>
            </td>
			<td>
            	<font color='#FF0000'><b>$str[3]</b></font>
            </td>
			<td>
            	<font color='#FF0000'><b>$str[4]</b></font>
            </td>
            <td>
            	<font color='#FF0000'><b>$str[5]</b></font>
            </td>
            <td>
            	<font color='#FF0000'><b><a href='Sıl.php?&urunid=$str[0]&urunAdi=$str[1]&sil=OK'>Sil</a></b></font>
            </td>
        </tr>";
}
echo "</table>";}
